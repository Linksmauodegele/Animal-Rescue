          ...
          <div className="lg:col-span-3 bg-white rounded-3xl p-8 border border-[#e8d8be] shadow-sm">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[#e8d8be] bg-[#f8f0e3] text-[#3d2e1e] text-sm focus:outline-none focus:ring-2 focus:ring-[#c4622d]/30 focus:border-[#c4622d] placeholder-[#b0946a]"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <select
                  id="subject"
                  className="w-full px-4 py-3 rounded-xl border border-[#e8d8be] bg-[#f8f0e3] text-[#3d2e1e] text-sm focus:outline-none focus:ring-2 focus:ring-[#c4622d]/30"
                >
                  <option value="">Pasirinkite temą</option>
                  <option value="adopt">Noriu įsivaikinti</option>
                  <option value="foster">Noriu tapti laikinu globėju</option>
                  <option value="volunteer">Noriu savanoriauti</option>
                  <option value="donate">Noriu paaukoti</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-[#e8d8be] bg-[#f8f0e3] text-[#3d2e1e] text-sm focus:outline-none focus:ring-2 focus:ring-[#c4622d]/30 focus:border-[#c4622d] placeholder-[#b0946a] resize-none"
                />
              </div>
